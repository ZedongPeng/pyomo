...
def add_baron_cuts(model):
    ...
    os.system("sed -i '1 a nouter1:100; ' root_relaxation_baron.bar")
    os.system("sed -i '1 a noutpervar:100; ' root_relaxation_baron.bar")
    os.system("sed -i '1 a noutiter:100; ' root_relaxation_baron.bar")
    os.system("sed -i '1 a outgrid:100; ' root_relaxation_baron.bar")
